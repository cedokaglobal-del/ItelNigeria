...
const PanelSVG = memo(function PanelSVG() {
  return (
    <svg
      viewBox="0 0 200 140"
      className="h-full w-full max-h-[180px] drop-shadow-[0_20px_30px_rgba(0,0,0,0.5)]"
    >
      <defs>
  ...
  return (
    <svg viewBox="0 0 200 140" className="h-full w-full max-h-[170px]">
      ...
      <rect
        ...
        stroke="oklch(0.68 0.18 244 / 0.5)"
      />
