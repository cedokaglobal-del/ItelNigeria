...
function seedOrders(): Order[] {
  ...
  return [
    ...
    },
    {
      ...
      customer: { name: "Folake Adeyemi", email: "folake@example.com", phone: "+234 806 333 4455" },
      items: [
        {
      ...
      status: "delivered",
      payment: "paystack",
      address: { line: "25 Marina Way", city: "Lagos", state: "Lagos" },
    },
    {
      id: "ITL-K6L3M7",
      date: new Date(now.getTime() - 7 * 86400000).toISOString(),
      customer: { name: "Yusuf Ibrahim", email: "yusuf@example.com", phone: "+234 809 222 5566" },
      items: [
        {
          slug: "itel-mppt-60a",
      ...
      status: "confirmed",
      payment: "flutterwave",
      address: { line: "10 Kano Rd", city: "Kaduna", state: "Kaduna" },
    },
    {
      id: "ITL-N8O4P9",
      date: new Date(now.getTime() - 2 * 86400000).toISOString(),
      customer: { name: "Ngozi Eze", email: "ngozi@example.com", phone: "+234 810 888 1122" },
      items: [
        {
      ...
      status: "cancelled",
      payment: "paystack",
      address: { line: "8 Market Rd", city: "Onitsha", state: "Anambra" },
    },
    {
      id: "ITL-R5S6T7",
      date: new Date(now.getTime() - 14 * 86400000).toISOString(),
      customer: { name: "Tunde Balogun", email: "tunde@example.com", phone: "+234 812 444 7788" },
      items: [
        {
      ...
      status: "delivered",
      payment: "transfer",
      address: { line: "3 Ibadan Rd", city: "Ibadan", state: "Oyo" },
    },
    {
      id: "ITL-U8V9W1",
      date: new Date(now.getTime() - 4 * 86400000).toISOString(),
      customer: { name: "Chioma Okafor", email: "chioma@example.com", phone: "+234 813 777 3344" },
      items: [
        {
          slug: "itel-ntype-600w",
          name: "Itel N-Type Bifacial 600W",
      ...
      status: "processing",
      payment: "paystack",
      address: { line: "22 Benin Rd", city: "Warri", state: "Delta" },
    },
  ];
}
...
function useLocalStorage<T>(
  ...
  const [state, setState] = useState<T>(() => {
    ...
    try {
      ...
      console.warn(`useLocalStorage(${key}): failed to parse`);
    }
    return seed();
  });
  ...
  useEffect(() => {
    try {
      ...
      console.warn(`useLocalStorage(${key}): failed to persist`);
    }
  }, [key, state]);
